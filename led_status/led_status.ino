...
void handleSerial() {
  ...
  switch (c) {
    ...
    case '1': currentMode = MODE_TELEOP_BLUE; break;
    case '2': currentMode = MODE_BLUE;        break;
    case '3': currentMode = MODE_GREEN;       break;
    case '4': currentMode = MODE_YELLOW;      break;
    case '5': currentMode = MODE_PURPLE;      break;
    case '6': currentMode = MODE_RED;         break;
...
CRGB blinkColorFor(Mode m) {
  switch (m) {
    case MODE_BLUE:   return CRGB::Blue;
    case MODE_GREEN:  return CRGB::Green;
    case MODE_YELLOW: return CRGB::Yellow;
    case MODE_PURPLE: return CRGB::Purple;
    case MODE_RED:    return CRGB::Red;
    default:          return CRGB::Black;
  }
}

bool isBlinkingMode(Mode m) {
  return m == MODE_BLUE  || m == MODE_GREEN || m == MODE_YELLOW ||
